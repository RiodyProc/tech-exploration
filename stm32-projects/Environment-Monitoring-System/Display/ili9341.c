...
uint8_t* ILI9341_Init(uint8_t orientation)
{
	...
	//else if (orientation == PAGE_ORIENTATION_LANDSCAPE) 		mem_config = ILI9341_MemoryDataAccessControlConfig(1, 1, 1, 1, 0, 0);//for the lvgl-9
	//else if (orientation == PAGE_ORIENTATION_LANDSCAPE) 		mem_config = ILI9341_MemoryDataAccessControlConfig(1, 1, 0, 1, 0, 1);
	else if (orientation == PAGE_ORIENTATION_LANDSCAPE) 		mem_config = ILI9341_MemoryDataAccessControlConfig(1, 1, 1, 1, 1, 0);// ideal for landscape
