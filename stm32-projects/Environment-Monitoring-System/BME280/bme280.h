...
#define BME280_ADDRESS 0xEC //BME280 I2C ADDRESS (0x76<<1)
...
#define BME280_REGISTER_DIG_H5 0xE5// Registers with calibrating data
...
#define BME280_STBY_10 0xC0  // STANDBY timings
#define BME280_FILTER_MSK 0x1C//	
#define BME280_FILTER_OFF 0x00//  
#define BME280_FILTER_2 0x04  //    
#define BME280_FILTER_4 0x08  //   
#define BME280_FILTER_8 0x0C  // FILTER Coefficients masks
...
#define BME280_OSRS_H_x16 0x05  // Oversampling configurations masks
#define BME280_MODE_MSK 0x03   //  
#define BME280_MODE_SLEEP 0x00 //  
#define BME280_MODE_FORCED 0x01//  
#define BME280_MODE_NORMAL 0x03// MODE settings
#define BME280_REGISTER_PRESSUREDATA 0xF7
#define BME280_REGISTER_TEMPDATA 0xFA
#define BME280_REGISTER_HUMIDDATA 0xFD
#define SEALEVELPRESSURE_HPA (1013.25)//
#define SEALEVELPRESSURE_PA (1013250)// sealevel coefficients
...
void BME280_WriteData(uint8_t Reg, uint8_t Value);
void BME280_ReadData(uint8_t Reg, uint8_t *Value);
void BME280_ReadData16(uint8_t Reg, uint16_t *Value);
void BME280_ReadData24(uint8_t Reg, uint32_t *Value);
...
typedef struct
{
  ...
  int16_t dig_H5;
  int8_t dig_H6;
} BME280_CalibData; // Struct for calibrate data
